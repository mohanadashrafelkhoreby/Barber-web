...
import { TIER_CONFIG, formatAdminDate } from '../../../data/admin';
import type { AdminCustomer } from '../../../data/admin';
import { SearchIcon, TrophyIcon, PhoneIcon, StarFilledIcon } from '../../../components/admin/AdminIcons';
        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((customer, i) => {
            ...
            return (
              ...
              >
                {/* Desktop row */}
                <div className="hidden md:grid grid-cols-[1fr_140px_100px_90px_100px] gap-4 items-center px-5 py-4 bg-[#0A0A0A] hover:bg-[#0F0F0F] transition-colors duration-100">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 mt-2">
                        <span className="text-xs font-body text-[#555]">
                        ...
                        <span className="text-xs font-body text-[#555]">
                          {formatAdminDate(customer.lastVisit)}
                        </span>
                      </div>
                    </div>
                  </div>
